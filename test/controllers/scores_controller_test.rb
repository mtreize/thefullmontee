...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { player_id: @score.player_id, round_id: @score.round_id, value: @score.value } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { player_id: @score.player_id, round_id: @score.round_id, value: @score.value } }
