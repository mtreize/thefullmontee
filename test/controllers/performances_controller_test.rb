...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { game_id: @performance.game_id, player_id: @performance.player_id, trophy_id: @performance.trophy_id } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { game_id: @performance.game_id, player_id: @performance.player_id, trophy_id: @performance.trophy_id } }
